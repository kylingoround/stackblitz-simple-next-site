...
<ImpactHighlight>
  <ImpactCell highlight='40%' description='Reduced time-to-help'/>
  <ImpactCell highlight='30%' description='Improved issue coverage'/>
  <ImpactCell highlight='3' description='Unified Experience Principles'/>
</ImpactHighlight>
...
<Col_5_TeamIntro 
  ...
  col5={[{'title': 'Design Director', 'name': ''}, {'title': 'UX Designer', 'name': ''}, {'title': 'UX Designer', 'name': ''}]}
/>

<ApproachSection>
  <ApproachLink href='#discovery'>Discovery & Journey Mapping</ApproachLink>
  <ApproachLink href='#principles'>Distill experience principles</ApproachLink>
  <ApproachLink href='#ideation'>Ideate opportunities</ApproachLink>
  <ApproachLink href='#alignment'>Alignment, prioritization and roadmap</ApproachLink>
  <ApproachLink href='#execution'>Execution</ApproachLink>
</ApproachSection>
